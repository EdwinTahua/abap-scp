...
@EndUserText.label: 'Xls file table'
@Metadata.ignorePropagatedAnnotations: true
define root view entity YI_SES_PARENT as select from //usr02           as _user
//    left outer join yses_file_table as _ses_file on _user.bname = _ses_file.end_user
yses_file_table as _ses_file 
  composition [0..*] of yI_SES_EXCEL_DATA as _ses_excel
{
...
//where
//  _ses_file.end_user = $session.user
